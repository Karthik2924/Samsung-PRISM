...
def save_mfcc(dataset_path, json_path, n_mfcc=13, n_fft=2048, hop_length=512, num_segments=10):
    ...
    excepted_num_mfcc_vectors_per_segment = math.ceil(num_samples_per_segment / hop_length)

    # loop through all the speech
    for i, (dirpath, dirnames, filenames) in enumerate(os.walk(dataset_path)):
        ...
        if dirpath is not dataset_path:
            ...
            # process files for a specific speech
            for f in filenames:
                ...
                if len(mfcc) == excepted_num_mfcc_vectors_per_segment:
